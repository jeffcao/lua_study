  ...
  class Synchronization
    ...
    def publish(notify_data)
      ...
      Fiber.new do
        ...
        Rails.logger.debug("[Synchronization.publish] game.transaction_notify, data=>"+notify_data.to_json)
        fredis_client.publish "game.transaction_notify", notify_data.to_json
      end.resume
    end
