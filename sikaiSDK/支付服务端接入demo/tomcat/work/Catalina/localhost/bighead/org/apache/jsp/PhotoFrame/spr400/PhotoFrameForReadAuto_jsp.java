...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
 ...
 String READ_FILE_FULL_PATH = application.getRealPath("/") + "PhotoFrame/spr400/" + RES_DOWNLOAD_PATH;
 ...
 for (int i = 0; i < files.length; i++) {
 	...
 	if(file.exists())//如果文件不存，则建立
	{
      ...
      out.print("PhotoFrame/spr400/" + RES_DOWNLOAD_PATH + fileName);
      out.write("&file_name=");
      out.print(fileName.substring(0,fileName.indexOf(".")));
      out.write("\">点击下载</a><br/>\r\n");
      out.write("\t<br/>\r\n");
