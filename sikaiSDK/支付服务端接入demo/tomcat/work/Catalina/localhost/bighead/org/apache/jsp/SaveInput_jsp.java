...
//String inputMessage = new String(inputInfo.getBytes("8859_1"),"UTF-8");
...
String allMessageName = "message.txt";

SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
String saveMessage = df.format(new Date()) + "\n" + inputMessage + "\n";
boolean ret;
WriteLocalFileUtils.writeFile(SAVE_MESSAGE_FULL_PATH, allMessageName, saveMessage, true);
ret = WriteLocalFileUtils.writeFile(SAVE_MESSAGE_FULL_PATH, dateMessageName, saveMessage, true);
if (!ret){
	out.println("<br/>留言提交失败请稍后再试！");
}else{
	out.println("<br/>留言提交成功！谢谢");
}
 
      out.write("\r\n");
      out.write(" \t<p>\r\n");
      out.write(" \t<br/>\r\n");
      out.write(" \t<a href=\"MessageBoard.jsp\">返回查看你的留言</a>\r\n");
      out.write(" \t</p>\r\n");
      out.write("  </body>\r\n");
      out.write("</html>\r\n");
    } catch (Throwable t) {
