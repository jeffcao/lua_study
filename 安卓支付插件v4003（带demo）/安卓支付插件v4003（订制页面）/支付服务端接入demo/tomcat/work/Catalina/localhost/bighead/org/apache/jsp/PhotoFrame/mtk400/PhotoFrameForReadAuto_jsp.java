...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
 ...
 String READ_FILE_FULL_PATH = application.getRealPath("/") + "PhotoFrame/mtk400/" + RES_DOWNLOAD_PATH;
