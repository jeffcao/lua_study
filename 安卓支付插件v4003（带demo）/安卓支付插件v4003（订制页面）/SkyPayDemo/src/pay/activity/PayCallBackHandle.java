	...
	public void handleMessage(Message msg) {
		...
		if (msg.what == SkyPayServer.MSG_WHAT_TO_APP) {
			...
			if (msgCode == 101) {
				/**
				 * 返回错误
				 * retInfo格式：msg_code=101&error_code=***
				 * error_code取值参考文档
				 */
				return;
			}
			...
			if (map.get(STRING_PAY_STATUS)!=null) {
				/**
				 * 短信付费结果返回
				 * retInfo失败格式：msg_code=100&pay_status=101&pay_price=0&errorcode=***
				...
				/**
				 * 第三方付费结果返回
				 * retInfo格式：msg_code=100&3rdpay_status=***&pay_price=***&skyChargeId=***
				 * 具体参数意义参考文档
				 */
			}
		}
