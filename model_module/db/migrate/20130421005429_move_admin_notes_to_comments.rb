class MoveAdminNotesToComments < ActiveRecord::Migration
  def self.up
   # remove_index  :admin_notes, [:super_user_type, :super_user_id]
    rename_table  :admin_notes, :active_admin_comments
    rename_column :active_admin_comments, :super_user_type, :author_type
    rename_column :active_admin_comments, :super_user_id, :author_id
  ...
  def self.down
    ...
    rename_column :active_admin_comments, :author_id, :super_user_id
    rename_column :active_admin_comments, :author_type, :super_user_type
    rename_table  :active_admin_comments, :admin_notes
    add_index     :admin_notes, [:super_user_type, :super_user_id]
  end
end
